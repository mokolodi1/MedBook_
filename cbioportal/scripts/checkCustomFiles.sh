if [[ -e /custom_files/ ]]; then
	...
	/bin/cp --force /custom_files/MedBook_LogoFull-010.png $CATALINA_HOME/webapps/cbioportal/images;
	/bin/cp --force /custom_files/ucsc_logo.gif $CATALINA_HOME/webapps/cbioportal/images;
